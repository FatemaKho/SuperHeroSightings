...
import java.util.List;
    ...
    public class SuperHumanDaoImpl implements SuperHumanDao {
        ...
        public SuperHuman getById(int superhumanId) {
            ...
            return jdbcTemplate.queryForObject(sql, new com.sg.SuperHero.dao.SuperHumanDaoImpl.SuperHumanRowMapper(), superhumanId);
        }

        @Override
        public List<SuperHuman> getAll() {
            String sql = "SELECT * FROM superhuman";
            return jdbcTemplate.query(sql, new com.sg.SuperHero.dao.SuperHumanDaoImpl.SuperHumanRowMapper());
        }
